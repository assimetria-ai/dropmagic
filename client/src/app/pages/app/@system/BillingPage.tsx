...
function statusBadgeVariant(status: StripeSubscription['status']): 'default' | 'secondary' | 'destructive' | 'outline' {
  switch (status) {
...
function statusLabel(status: StripeSubscription['status'], cancelAtPeriodEnd: boolean) {
