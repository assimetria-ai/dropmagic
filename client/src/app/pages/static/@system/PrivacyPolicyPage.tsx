      ...
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <Section title="1. Information We Collect">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              ...
              information such as profile picture, role, or preferences.
            </li>
            <li>
        ...
        <Section title="5. Data Retention">
          <p>
            ...
            as needed to provide services. After account deletion we retain certain
        ...
        <Section title="6. Cookies">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              ...
              your settings such as theme or language.
            </li>
          </ul>
        </Section>
